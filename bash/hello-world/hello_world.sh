...
main() {
  ...
  # Add your code here
  # ---------------------------------------------------------------------------
  # tivasyk : well, i really had to guess hard what to do with this! there are
  # almost no indications on the "hello, world!" exercise page as to what one
  # has to do once exercism is configured, bats is installed and the exercise
